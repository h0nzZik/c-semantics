...
package () {
  ...
  # QtQuickApp does support "make install", but we don't use it
  # because we want to show the manual packaging approach in this example.
  # Initialize AppDir, bundle shared libraries, add desktop file and icon,
  # use Qt plugin to bundle additional resources, and build AppImage, all in one command.
...
# TODO I should probably rename the 'packages' directory
